...
ALLCFLAGS+= $(CFLAGS_PLATFORM)
NASMFLAGS+= $(NASMFLAGS_PLATFORM)
endif
...
NASM=$(XNASM)
NASMFLAGS+=-I..$(DIRSEP)..$(DIRSEP)hdr -DXCPU=$(XCPU) -felf -o $(MK_TGT)
...
ALLCFLAGS+=-I..$(DIRSEP)..$(DIRSEP)hdr $(TARGETOPT) -mcmodel=small -fleading-underscore -fno-common -fpack-struct -ffreestanding -fcall-used-es -mrtd -Wno-pointer-to-int-cast -Wno-pragmas -Werror -Os -fno-strict-aliasing -mfar-function-if-far-return-type
INITCFLAGS=$(ALLCFLAGS) -o $(MK_TGT)
CFLAGS=$(ALLCFLAGS) -o $(MK_TGT)
ASSEMBLE=$(NASM) -D$(COMPILER) $(NASMFLAGS) $(MK_DEP)
COMPILE_CC=$(CC) -o $(MK_TGT) $(MK_DEP)
...
CLDEF=1
CLT=gcc -Wall -DDOSC_TIME_H -I../hdr -o $(MK_TGT)
CLC=$(CLT)
